...
export default function PrimarySearchAppBar() {
  ...
  const BootstrapInput = styled(InputBase)(({ theme }) => ({
    ...
    '& .MuiInputBase-input': {
      borderRadius: 4,
      position: 'relative',
      backgroundColor: theme.palette.mode === 'light' ? '#fcfcfb' : '#fc8019',
      ...
      '&:focus': {
        boxShadow: `#fc8019 0 0 0 0.05rem`,
        borderColor: '#fc8019',
      },
    },
  }));
    ...
    <Box sx={{ flexGrow: 1, background: "white" }}>
      ...
      <AppBar position="static" sx={{ background: "white",color: "#3d4152", }}>
        <Toolbar>
          ...
          <Box  sx={{ ml:8, width:"300px", display: { xs: 'none', md: 'flex' }, justifyContent: 'space-around' }}>
          
            <IconButton sx={{'&:hover': {color: "#f77103"}, ml:8.2}}  size="large" aria-label="show 4 new mails" color="inherit" >
                <SupportIcon  />
